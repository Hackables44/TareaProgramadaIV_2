...
int main(){
	...
	// // Hilera * * hileraPtr;
	// // Hilera * vHilera[cantidadHileras];
	// // //hileraPtr = vHilera;
	
	// // // Hilera * * hileras = new * Hilera[cantidadHileras]; /** Es un vector de punteros a objetos Hilera*/
	// // for(int i=0; i<cantidadHileras; ++cantidadHileras){
		// // vHilera[i] = new Hilera(); /** crea instancias de Hilera y devuelve el puntero a ese objeto*/
	// // }
	
	// // /** Asigno las palabras a los objetos hilera */
	// // vHilera[0]->setPalabras(palabras1, 2);
	// // vHilera[1]->setPalabras(palabras2, 5);
	// // vHilera[2]->setPalabras(palabras3, 4);
	// // vHilera[3]->setPalabras(palabras4, 4);
